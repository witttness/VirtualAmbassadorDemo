...
/* harmony import */ var _zxing_ngx_scanner__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @zxing/ngx-scanner */ "./node_modules/@zxing/ngx-scanner/fesm5/zxing-ngx-scanner.js");
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJleGhpYml0L2RlY2lkZS9kZWNpZGUuY29tcG9uZW50LnNjc3MifQ== */"
...
var DECIDEComponent = /** @class */ (function () {
    function DECIDEComponent(svc) {
        this.svc = svc;
    }
    DECIDEComponent.prototype.ngOnInit = function () {
    };
    DECIDEComponent.prototype.rateExhibit = function (e) {
        console.info('rate exhibit', e);
        this.svc.saveRating('DECIDE', e.rating);
    };
    DECIDEComponent.ctorParameters = function () { return [
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJleGhpYml0L2V4aGliaXQuY29tcG9uZW50LnNjc3MifQ== */"
...
var ExhibitComponent = /** @class */ (function () {
    function ExhibitComponent(route) {
        this.route = route;
        this.exhibitId$ = route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (p) { return p.exhibitId; }));
    }
    ExhibitComponent.prototype.ngOnInit = function () {
    };
    ExhibitComponent.ctorParameters = function () { return [
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJleGhpYml0L3NjYXJjaXR5L3NjYXJjaXR5LmNvbXBvbmVudC5zY3NzIn0= */"
...
var SCARCITYComponent = /** @class */ (function () {
    function SCARCITYComponent(svc) {
        this.svc = svc;
    }
    SCARCITYComponent.prototype.ngOnInit = function () {
    };
    SCARCITYComponent.prototype.rateExhibit = function (e) {
        console.info('rate exhibit', e);
        this.svc.saveRating('SCARCITY', e.rating);
    };
    SCARCITYComponent.ctorParameters = function () { return [
        { type: src_app_my_service__WEBPACK_IMPORTED_MODULE_2__["MyService"] }
    ]; };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(router, svc) {
        this.router = router;
        this.svc = svc;
    }
    HomeComponent.prototype.ngOnInit = function () {
    };
    HomeComponent.prototype.goToExhibitDemo = function () {
        var _this = this;
        setTimeout(function () {
            _this.router.navigateByUrl("exh-SCARCITY");
        }, 10000);
    };
    HomeComponent.prototype.startAnonymous = function () {
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJtYXAvbWFwLmNvbXBvbmVudC5zY3NzIn0= */"
...
var MyService = /** @class */ (function () {
    ...
    MyService.prototype.startVisit = function () {
        var _this = this;
        var data = {
        ...
        this.http.post("/VAmbassadorService/api/visit/Start", data)
            .toPromise()
            .then(function (id) {
            _this.storeVisitorId(id);
        });
    };
    MyService.prototype.startAnonymousVisit = function () {
        var _this = this;
        this.http.post("/VAmbassadorService/api/visit/StartAnonymous", null)
            .toPromise()
            .then(function (id) {
            _this.storeVisitorId(id);
        });
    };
    MyService.prototype.visitExhibit = function (stationId) {
        var data = {
            "VisitorId": this.visitorId,
            "StationId": stationId,
            "Description": "",
        };
        this.http.post("/VAmbassadorService/api/visit/SaveStats", data)
            .toPromise()
            .then(function (id) {
            console.info('saveStats id', id);
        });
    };
    MyService.prototype.saveRating = function (stationId, rating) {
        var data = {
            "VisitorId": this.visitorId,
            "StationId": stationId,
            "Rate": rating
        };
        this.http.post("/VAmbassadorService/api/visit/SaveRating", data)
            .toPromise()
            .then(function (id) {
            console.info('saveRating id', id);
        });
    };
    MyService.prototype.storeVisitorId = function (id) {
        this.visitorId = id;
        sessionStorage.setItem(this.VIS_ID_KEY, "" + id);
    };
    MyService.prototype.loadVisitorId = function () {
        var visIdStr = sessionStorage.getItem(this.VIS_ID_KEY);
        var visId = parseInt(visIdStr);
        if (visId)
            this.visitorId = visId;
        return visId;
    };
    MyService.prototype.setVisitorZip = function (zip) {
        this.visitorData.zip = zip;
    };
    MyService.prototype.setVisitorAge = function (age) {
        this.visitorData.age = age;
    };
    MyService.prototype.setVisitorGroup = function (group) {
        this.visitorData.group = group;
    };
    MyService.prototype.setVisitorEducation = function (education) {
...
module.exports = "a.navbar-brand {\n  white-space: normal;\n  text-align: center;\n  word-break: break-all;\n}\n\nhtml {\n  font-size: 14px;\n}\n\n@media (min-width: 768px) {\n  html {\n    font-size: 16px;\n  }\n}\n\n.box-shadow {\n  box-shadow: 0 0.25rem 0.75rem rgba(0, 0, 0, 0.05);\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzY2FuL3NjYW4uY29tcG9uZW50LnNjc3MifQ== */"
...
var ScanComponent = /** @class */ (function () {
    function ScanComponent(router, svc) {
        this.router = router;
        this.svc = svc;
    ...
    ScanComponent.prototype.ngOnDestroy = function () {
        this.lightOn = false;
        this.scannerOn = false;
    };
    ScanComponent.prototype.onTorchCompatible = function (e) {
        var _this = this;
    ...
    ScanComponent.prototype.scanSuccess = function (data) {
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJ2aXNpdG9yLWluZm8vZ2V0LWFnZS9nZXQtYWdlLmNvbXBvbmVudC5zY3NzIn0= */"
...
var GetAgeComponent = /** @class */ (function () {
    function GetAgeComponent(router, svc) {
        this.router = router;
        this.svc = svc;
        this.age = svc.visitorData.age;
    }
    GetAgeComponent.prototype.ngOnInit = function () {
    };
    GetAgeComponent.prototype.goBack = function () {
        this.router.navigateByUrl('visitorInfo/getZip');
    };
    GetAgeComponent.prototype.goNext = function () {
        this.svc.setVisitorAge(this.age);
        this.router.navigateByUrl('visitorInfo/getGroup');
    };
    GetAgeComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJ2aXNpdG9yLWluZm8vZ2V0LWVkdWNhdGlvbi9nZXQtZWR1Y2F0aW9uLmNvbXBvbmVudC5zY3NzIn0= */"
...
var GetEducationComponent = /** @class */ (function () {
    function GetEducationComponent(router, svc) {
        this.router = router;
        this.svc = svc;
        this.education = svc.visitorData.education;
    }
    GetEducationComponent.prototype.ngOnInit = function () {
    };
    GetEducationComponent.prototype.goBack = function () {
        this.router.navigateByUrl('visitorInfo/getGroup');
    };
    GetEducationComponent.prototype.goNext = function () {
        this.svc.setVisitorEducation(this.education);
        this.router.navigateByUrl('thanks');
    };
    GetEducationComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: src_app_my_service__WEBPACK_IMPORTED_MODULE_3__["MyService"] }
    ]; };
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJ2aXNpdG9yLWluZm8vZ2V0LWdyb3VwL2dldC1ncm91cC5jb21wb25lbnQuc2NzcyJ9 */"
...
var GetGroupComponent = /** @class */ (function () {
    function GetGroupComponent(router, svc) {
        this.router = router;
        this.svc = svc;
        this.group = svc.visitorData.group;
    }
    GetGroupComponent.prototype.ngOnInit = function () {
    };
    GetGroupComponent.prototype.goBack = function () {
        this.router.navigateByUrl('visitorInfo/getAge');
    };
    GetGroupComponent.prototype.goNext = function () {
        this.svc.setVisitorGroup(this.group);
        this.router.navigateByUrl('visitorInfo/getEducation');
    };
    GetGroupComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: src_app_my_service__WEBPACK_IMPORTED_MODULE_3__["MyService"] }
    ]; };
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJ2aXNpdG9yLWluZm8vZ2V0LXppcC9nZXQtemlwLmNvbXBvbmVudC5zY3NzIn0= */"
...
var GetZipComponent = /** @class */ (function () {
    function GetZipComponent(router, svc) {
        this.router = router;
        this.svc = svc;
        this.zip = svc.visitorData.zip;
    }
    GetZipComponent.prototype.ngOnInit = function () {
    };
    GetZipComponent.prototype.goBack = function () {
        this.router.navigateByUrl('/');
    };
    GetZipComponent.prototype.goNext = function () {
        this.svc.setVisitorZip(this.zip);
        this.router.navigateByUrl('visitorInfo/getAge');
    };
    GetZipComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: src_app_my_service__WEBPACK_IMPORTED_MODULE_3__["MyService"] }
    ]; };
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJ2aXNpdG9yLWluZm8vdmlzaXRvci1pbmZvLmNvbXBvbmVudC5zY3NzIn0= */"
...
var VisitorInfoComponent = /** @class */ (function () {
    function VisitorInfoComponent() {
    }
    VisitorInfoComponent.prototype.ngOnInit = function () {
    };
    VisitorInfoComponent.prototype.prepareRoute = function (outlet) {
        return outlet && outlet.activatedRouteData && outlet.activatedRouteData['animation'];
    };
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJ2aXNpdG9yLXRoYW5rcy92aXNpdG9yLXRoYW5rcy5jb21wb25lbnQuc2NzcyJ9 */"
...
var VisitorThanksComponent = /** @class */ (function () {
    function VisitorThanksComponent(svc, router) {
        this.svc = svc;
        this.router = router;
        this.data = svc.visitorData;
    }
    VisitorThanksComponent.prototype.ngOnInit = function () {
    };
    VisitorThanksComponent.prototype.startVisit = function () {
        this.svc.startVisit();
        this.router.navigateByUrl('map');
    };
    VisitorThanksComponent.ctorParameters = function () { return [
